...
public class Meal {
    ...
    public List<String> getAllMeasures() {
        ...
        for(int i =1 ;i<=20;i++){
            try {
                Field field = getClass().getDeclaredField("strMeasure"+i);
    ...
    public void setAllIngredients(List<String> ingredients) {
        for (int i = 0; i < ingredients.size(); i++) {
            try {
                Field field = getClass().getDeclaredField("strIngredient" + (i + 1));
                field.set(this, ingredients.get(i));
            } catch (NoSuchFieldException | IllegalAccessException e) {
                e.printStackTrace();
            }
        }
    ...
    public void setAllMeasures(List<String> measures) {
        for (int i = 0; i < measures.size(); i++) {
            try {
                Field field = getClass().getDeclaredField("strMeasure" + (i + 1));
                field.set(this, measures.get(i));
            } catch (NoSuchFieldException | IllegalAccessException e) {
                e.printStackTrace();
            }
        }
